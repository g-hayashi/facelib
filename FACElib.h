...
#define IFACE_wRunTimer(This,Interval)	\
    (This)->lpVtbl -> wRunTimer(This,Interval)
...
#define IFACE_SpriteLoadFromFile(This,SpriteID,FileName)	\
    (This)->lpVtbl -> SpriteLoadFromFile(This,SpriteID,FileName)
...
#define IFACE_fOpen(This,FileName)	\
    (This)->lpVtbl -> fOpen(This,FileName)
...
#define IFACE_Graphics(This,lGraphMode)	\
    (This)->lpVtbl -> Graphics(This,lGraphMode)
...
#define IFACE_Sound(This,lSoundMode)	\
    (This)->lpVtbl -> Sound(This,lSoundMode)
...
#define IFACE_Download(This,URL,FileName)	\
    (This)->lpVtbl -> Download(This,URL,FileName)
...
#define IFACE_mci(This,CMDStr,FilePath,Optional)	\
    (This)->lpVtbl -> mci(This,CMDStr,FilePath,Optional)
